		...
		<section class="pad-tb15 bg-gray flex-center">
			<fieldset>
				...
				<table class="width800">
					<tr class="bd-bottom">
						<td class="pad5 bd-right width35per">회원번호</td>
					...
					<tr>
						<td colspan="2">
							<button class="bg-gray pad5 margin5" onclick="memberUpdate()">
								<div class="font-size15">수&nbsp정</div>
							</button>
